public class JobConfigurator {
    ...
    Sites.inclusiveHosts.each { host ->
        Sites.inclusiveProducts.each { product ->
          ...
          map[jobName] = [
            ...
            description : hostconf.containsKey('description') ? hostconf.get('description')(jobName, "boo") : Values.stdDescription(jobName, "boo"),
  ...
  public void addCustomMaps(map) {
    ...
    Sites.customJobs.each { jobName, conf ->
          ...
          map[jobName] = [
            label : conf['label'],
            description : conf.containsKey('description') ? conf.get('description')(jobName, "boo") : Values.stdDescription(jobName, "boo"),
